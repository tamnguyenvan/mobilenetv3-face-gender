...
def get_args_parser(add_help=True):
    ...
    parser.add_argument("--num-classes", default=3, type=str, help="Number of gender classes")
...
def main(args):
    ...
    model = lib.detection.ssdlite320_mobilenet_v3_large(
        pretrained=False, num_classes=2, num_gender_classes=args.num_classes, **kwargs)
