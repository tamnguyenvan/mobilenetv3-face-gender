...
class SSDLiteHead(nn.Module):
    def __init__(self, in_channels: List[int], num_anchors: List[int], num_classes: int,
                 num_gender_classes: int, norm_layer: Callable[..., nn.Module]):
        super().__init__()
        ...
        self.gender_head = SSDLiteClassificationHead(in_channels, num_anchors, num_gender_classes, norm_layer)
...
def ssdlite320_mobilenet_v3_large(pretrained: bool = False, progress: bool = True, num_classes: int = 2,
                                  num_gender_classes: int = 3,
    ...
    model = SSD(backbone, anchor_generator, size, num_classes,
                head=SSDLiteHead(out_channels, num_anchors, num_classes, num_gender_classes, norm_layer), **kwargs)
